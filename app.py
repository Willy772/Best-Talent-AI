...
class QuestionsEntretien(BaseModel):
    ...
    questions: list[str] = Field(description="Liste de 5 questions d'entretien")

questions_prompt = ChatPromptTemplate.from_template(
    """
    Génère 5 questions d'entretien personnalisées pour le candidat suivant en fonction de son CV et de l'offre :\n
    Offre :\n{offre}\n
    CV :\n{cv}\n
    Nom du candidat :\n{nom}\n
    Note :\n{note}\n
